        ...
        if ($contentStep==1){
                ...
                if (floor($_GET['drop'])>0)
                {
                        ...
                        $before = $SiteSections->get(floor($_GET['before']),-1); $before['id'] = floor($before['id']);
                		 ...
                		 if ($drop['id']>0 && !isset($_GET['change_prec'])){
                        ...
                        elseif ($drop['parent']==$destination['parent'])
                        {
                ...
                <div id="content" class="listing">
                        ...
                        <form name="sectionedit" action="<?=configGet("AskUrl")?>?edit=<?=$editsection['id']?>" method="POST">
                                ...
                                <div class="place">
                                        ...
                                        <span class="input">
                                                <span class="bl"></span>
                                                <span class="bc"><input name="title" maxlength="500" value="<?=htmlspecialchars($editdata['title'])?>" /></span>
                                                <span class="br"></span>
                                        </span>
                                        </td><td>
                                        <label>Описание (description)</label>
                                        <span class="input">
                                                <span class="bl"></span>
                                                <span class="bc"><input name="description" maxlength="500" value="<?=htmlspecialchars($editdata['description'])?>" /></span>
                                                <span class="br"></span>
                                        </span>
                                        </td><td>
                                        <label>Ключевые слова (keyword)</label>
