...
$place_iface=getiface('/sitecontent/'.$banner_Section['path'].'/places/');
$place_Section = $SiteSections->get($SiteSections->getIdByPath('/sitecontent/'.$banner_Section['path'].'/places/'));
