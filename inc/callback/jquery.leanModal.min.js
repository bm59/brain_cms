...
$(modal_id).css({"display":"block","position":"fixed","opacity":0,"z-index":99999999,"left":50+"%","margin-left":-(modal_width/2)+"px","top":o.top+"px"});$(modal_id).fadeTo(200,1);e.preventDefault()})});
