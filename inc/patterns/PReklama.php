<?
$source_descr='Реклама';
$source_name='PReklama';
/* Имя класса */
class PReklama extends VirtualPattern
{
	function init($settings){
		...
		(
				...
				(
						...
						'types'=>array
						(
							array('name'=>'name', 'description'=>'Клиент', 'type'=>'CDText',  'settings'=>array('important'=>'', 'show_search'=>'', 'show_list'=>'', 'show_list'=>'')),
							...
							array('name'=>'precedence', 'description'=>'Приоритет', 'type'=>'CDSpinner',  'settings'=>array('show_list'=>'', 'default'=>'0', 'list_class'=>'t_minwidth')),
							array('name'=>'href', 'description'=>'Ссылка', 'type'=>'CDText',  'settings'=>array('show_search'=>'', 'show_list'=>'', 'list_class'=>'t_minwidth')),
							array('name'=>'section_id', 'description'=>'Раздел', 'type'=>'CDInteger',  'settings'=>array('important'=>'', 'show_list'=>'', 'list_class'=>'t_minwidth')),
							array('name'=>'item_id', 'description'=>'Запись', 'type'=>'CDInteger', 'settings'=>array('important'=>'', 'show_list'=>'', 'list_class'=>'t_minwidth')),
						)
		...
		$this->setSetting('table_stat',mstable(ConfigGet('pr_name').'_site','reklama','stat',array('item_id'=>'BIGINT(20)', 'date'=>'DATE', 'show'=>'BIGINT(20) DEFAULT 0', 'click'=>'BIGINT(20) DEFAULT 0', 'unique'=>'BIGINT(20) DEFAULT 0')));
