...
Шаблон справочника
*/
class PSprOrder extends VirtualPattern
{
	function init($settings){
		...
		$settings['name'] = 'PSprOrder';
		$settings['dataset'] = $CDDataSet->checkPresence(0,'sprorder');
		...
		(
			...
			(
					'name'=>'sprorder',
					'description'=>'Справочник с порядком',
					'types'=>array
					(
...
$registeredPatterns[] = array('name'=>'PSprOrder','description'=>'Справочник с порядком','useradd'=>1);
